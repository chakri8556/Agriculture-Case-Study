...
@Component({
  selector: 'app-sfarmer',
  templateUrl: './sfarmer.component.html',
  styleUrls: ['./sfarmer.component.css'],
})
export class SFarmerComponent implements OnInit {
  closeResult!: String;
  editForm!: FormGroup;
  deleteID!: number;
  constructor(
  ...
  // onSubmit(f: NgForm) {
  //   const url = 'http://localhost:9001/farmer/byid' + this.viewId;
